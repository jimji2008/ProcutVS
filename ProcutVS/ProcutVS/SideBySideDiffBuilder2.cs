...
{
	public class SideBySideDiffBuilder2 : ISideBySideDiffBuilder
	{
		...
		private void BuildWordDiffPieces(string oldText, string newText, List<DiffPiece> oldPieces, List<DiffPiece> newPieces)
		{
			...
			BuildDiffPieces(diffResult, oldPieces, newPieces, BuildCharDiffPieces);
		}

		private void BuildCharDiffPieces(string oldText, string newText, List<DiffPiece> oldPieces, List<DiffPiece> newPieces)
		{
			var diffResult = differ.CreateCharacterDiffs(oldText, newText, false, true);
